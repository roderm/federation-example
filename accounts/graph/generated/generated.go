...
type QueryResolver interface {
	...
	Self(ctx context.Context) (model.Identity, error)
}
...
func (ec *executionContext) _Query_self(ctx context.Context, field graphql.CollectedField) (ret graphql.Marshaler) {
	...
	fc.Result = res
	return ec.marshalOIdentity2githubᚗcomᚋwundergraphᚋgraphqlᚑgoᚑtoolsᚋexamplesᚋfederationᚋaccountsᚋgraphᚋmodelᚐIdentity(ctx, field.Selections, res)
}
...
var userImplementors = []string{"User", "Identity", "_Entity"}
...
func (ec *executionContext) marshalOIdentity2githubᚗcomᚋwundergraphᚋgraphqlᚑgoᚑtoolsᚋexamplesᚋfederationᚋaccountsᚋgraphᚋmodelᚐIdentity(ctx context.Context, sel ast.SelectionSet, v model.Identity) graphql.Marshaler {
	if v == nil {
		return graphql.Null
	}
